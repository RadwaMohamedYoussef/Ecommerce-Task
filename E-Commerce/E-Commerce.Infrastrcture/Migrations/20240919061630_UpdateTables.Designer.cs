...
namespace E_Commerce.Infrastrcture.Migrations
{
    ...
    [Migration("20240919061630_UpdateTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce.Domain.Models.Store", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce.Domain.Models.Order", b =>
                {
                    b.HasOne("E_Commerce.Domain.Models.User", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Commerce.Domain.Models.Store", "Store")
                        .WithMany()
            ...
            modelBuilder.Entity("E_Commerce.Domain.Models.Store", b =>
                {
                    b.HasOne("E_Commerce.Domain.Models.User", "Owner")
                        .WithMany()
